...
from ...models.stark import build_stark_lightning_x_trt
from .stark_utils import PreprocessorX
from ...utils.box_ops import clip_box
from ...models.stark.repvgg import repvgg_model_convert
# for onnxruntime
from .stark_utils import PreprocessorX_onnx
import onnxruntime
import multiprocessing


root_dir = os.path.abspath(__file__).split('lib')[0]
...
class STARK_LightningXtrt_onnx(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        self.ort_sess_z = onnxruntime.InferenceSession(os.path.join(root_dir, "onnx/backbone_bottleneck_pe.onnx"), 
                                                       providers=providers,
                                                       provider_options=provider_options)
        self.ort_sess_x = onnxruntime.InferenceSession(os.path.join(root_dir, "onnx/complete.onnx"), 
                                                       providers=providers,
                                                       provider_options=provider_options)
