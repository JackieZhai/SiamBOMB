from .featurebase import FeatureBase, MultiFeatureBase
import torch
import torchvision
from ...pytracking import TensorList
from os import path
from ..utils.loading import load_network
from ..models.backbone.resnet18_vggm import resnet18_vggmconv1
from ..models.backbone.mobilenetv3 import mobilenet3
...
class ResNet18m1(MultiFeatureBase):
    ...
    def initialize(self):
        ...
        if path.isabs(self.net_path):
            net_path_full = [self.net_path]
        else:
            root_paths = network_path
            if isinstance(root_paths, str):
                root_paths = [root_paths]
            net_path_full = [path.join(root, self.net_path) for root in root_paths]
