...
def _setup_legacy_env():
    # default compatible
    sys.modules['dlframework'] = sys.modules['SiamBOMB.pytracking']
    sys.modules['dlframework.common'] = sys.modules['SiamBOMB.pytracking']
    sys.modules['dlframework.common.utils'] = sys.modules['SiamBOMB.pytracking.admin']
    for m in ('model_constructor', 'stats', 'settings', 'local'):
        importlib.import_module('SiamBOMB.pytracking.admin.' + m)
        sys.modules['dlframework.common.utils.' + m] = sys.modules['SiamBOMB.pytracking.admin.' + m]
    # ltr compatible
    sys.modules['ltr'] = sys.modules['SiamBOMB.pytracking']
    sys.modules['ltr.models'] = sys.modules['SiamBOMB.pytracking.models']
    sys.modules['ltr.admin.settings'] = sys.modules['SiamBOMB.pytracking.admin.settings']
    sys.modules['ltr.admin.local'] = sys.modules['SiamBOMB.pytracking.admin.local']
    # pytracking compatible
    sys.modules['pytracking'] = sys.modules['SiamBOMB.pytracking']
