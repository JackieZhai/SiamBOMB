...
from .online.classifier import features as clf_features
from .online.classifier import initializer as clf_initializer
from .online.classifier import optimizer as clf_optimizer
from .online.classifier import linear_filter as target_clf
