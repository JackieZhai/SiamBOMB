...
def _setup_legacy_env():
    ...
    # default compatible
    sys.modules['dlframework'] = sys.modules['pytracking']
    sys.modules['dlframework.common'] = sys.modules['pytracking']
    importlib.import_module('pytracking.admin')
    sys.modules['dlframework.common.utils'] = sys.modules['pytracking.admin']
    for m in ('model_constructor', 'stats', 'settings', 'local'):
        importlib.import_module('pytracking.admin.' + m)
        sys.modules['dlframework.common.utils.' + m] = sys.modules['pytracking.admin.' + m]
    # ltr compatible
    sys.modules['ltr'] = sys.modules['pytracking']
    sys.modules['ltr.models'] = sys.modules['pytracking.models']
    sys.modules['ltr.admin.settings'] = sys.modules['pytracking.admin.settings']
    sys.modules['ltr.admin.local'] = sys.modules['pytracking.admin.local']
